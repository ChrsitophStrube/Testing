...
public class UsertestMax
{
    ...
    public async Task TestCTRLVarInProperties2()
    {
        ...
        // Get Text
        int minValue = _ctrlVarIn.MinimumProperty;
        Assert.That(minValue.Equals(0), $"Wrong initial Minimum. Value is: {minValue}");

        int maxValue = _ctrlVarIn.MaximumProperty;
        Assert.That(maxValue.Equals(10), $"Wrong initial Maximum. Value is: {maxValue}");

        // Set Value By UI
        _ctrlVarIn.ValueProperty = -10;
