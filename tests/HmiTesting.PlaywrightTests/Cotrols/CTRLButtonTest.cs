...
public class CTRLButtonTest : UiTestBase
{

    private CTRL_Button _ctrlButton;
    ...
    public async Task Setup()
    {
        ...
        _ctrlButton = area1.getElementByName<CTRL_Button>("CoT_CTRL_Button");
    }
    ...
    public async Task TestCTRLButtonCheckButtonExsistence()
    {
        ...
        ILocator buttonLocator = _ctrlButton.button._button.Locator;
