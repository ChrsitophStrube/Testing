...
public class BaseCTRLInWithLabel : CMPInput
{
    ...
    public BaseCTRLInWithLabel(IOpcUaSession session, LocatorNodeId control, string labelName, string labelTextPropertyName) : base(session, control)
    {
        _session = session;
        _control = control;
